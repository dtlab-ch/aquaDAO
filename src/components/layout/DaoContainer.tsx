...
const Dao = ({
  ...
  const navLinks = useMemo(() => {
    let baseLinks = [
      { label: "Home", href: `https://aqua-life.surge.sh/` },
      { label: "DAO", href: `/${routePath}` },
      { label: "Propuestas", href: `/${routePath}/proposals` },
      { label: "Personas", href: `/${routePath}/members` },    
    ];

    return address
      ? [
          ...baseLinks,
          { label: "Perfil", href: `/${routePath}/member/${address}` },
        ]
      : baseLinks;
